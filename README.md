...
Sample Android app that we use at [W3 Engineers Ltd](https://w3engineers.com) as a reference for new Android projects. It demonstrates the architecture, tools and guidelines that we use when developing for the Android platform [See this Pdf] (https://code.leftofthedot.com/anjan/mvp-architecture-app/blob/master/Android-Project-Guideline_v1.1.pdf)
...
To quickly start a new project from this skeleton follow the next steps:

* Download this [repository as a zip](https://code.leftofthedot.com/anjan/mvp-architecture-app/repository/master/archive.zip).
* Also you can watch this [see video] (https://youtu.be/5lNtgudQS_Y)
